...
//   const handleCancel = () => {
//     if (cart.size === 0) {
//       // If the cart is empty, navigate back without showing a confirmation dialog
//       window.history.back();
//     } else {
...
//                 </AlertDialogHeader>
//                 <AlertDialogDescription>
//                   If you go back, your cart will be deleted
//                 </AlertDialogDescription>
//                 <AlertDialogFooter>
//                   <AlertDialogAction className="hover:bg-gray-300 bg-gray-400">
//                     Go back
//                   </AlertDialogAction>
//                   <AlertDialogCancel>
//                     <Button
//                       onClick={handleCancelConfirmed}
//                       className="hover:bg-red-600 bg-red-800 text-red-50"
//                     >
//                       Delete cart
//                     </Button>
//                   </AlertDialogCancel>
